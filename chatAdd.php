...
<body>
    ...
    <form name="frmUser" method="post" action="chatController.php">
        <div class="card-header"><strong>Add Answers</strong> </div>
...
<div class="form-group">
    ...
    <input type="text" name="question" class="txtField" required>
</div>
<div class="form-group">
    <label>   Answer : </label><br>
    <input type="text" name="answer" class="txtField" required>
</div>
<div class="form-group">
    <label>   Active:</label><br>
    <input type="text" name="active" class="txtField" required >
</div>
<div class="form-group">
